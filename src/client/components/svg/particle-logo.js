...
const { svg, path, g, rect, polygon, style } = React.DOM;


export default createClass({
    displayName: 'ParticleLogo',
    render(){
        return svg({ viewBox: '0 0 3849.5 890', xmlns: 'http://www.w3.org/2000/svg' },
            style(null, `
                .logo-spark{fill:#00AEEF;}
                .st1{fill:none;}
            `),
            ...
            g(null,
                rect({ x: '2712.6', y: '289.9', width: '48', height: '495.6' }),
                rect({ x: '2712.6', y: '131.5', width: '48', height: '78.4' })
            ),
            g(null,
                g(null,
                    polygon({ className: 'logo-spark', points: '890,445 653.1,495.9 620.2,445 653.1,394.1' }),
                    polygon({ className: 'logo-spark', points: '445,620.2 495.9,653.1 445,890 394.1,653.1' }),
                    polygon({ className: 'logo-spark', points: '445,0 495.9,236.9 445,269.8 394.1,236.9' }),
                    polygon({ className: 'logo-spark', points: '236.9,394.1 269.8,445 236.9,495.9 0,445' })
                ),
                polygon({ className: 'logo-spark', points: '759.7,130.3 556.2,445 759.7,759.6 445,556.2 130.3,759.6 333.8,445 130.3,130.3 445,333.7' })
            ),
            path({ className: 'st1', d: 'M1059,508.5' }),
            path({ className: 'st1', d: 'M1249,508.5' })
        );
    }
});
